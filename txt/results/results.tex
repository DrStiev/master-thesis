...
\begin{tabular}{ |p{2,57cm}||p{2,57cm}|p{2,57cm}|p{2,57cm}|p{2,57cm}|  }
	...
	\multicolumn{5}{|c|}{Tempo Impiegato} \\
	\hline
	Tipologia di Test & Nodi Infetti Variabili & Valore di Migrazione Variabile & Nodi della Rete Variabile & Copertura dei Nodi Variabile\\
	\hline
	Paramscan & bla & bla & bla & bla\\
	\hline
\end{tabular}
