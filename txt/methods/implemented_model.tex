...
\begin{figure}[H]
    \begin{center}
		\includegraphics[scale=0.4]{img/Moreno_Sociogram_3rd_Grade.png}
...
\begin{figure}[H]
    \begin{center}
		...
		\caption{Funzione che si occupa di simulare la ricerca di un vaccino e la sua successiva applicazoine}
		\label{fig:vaccine}
	\end{center}
\end{figure}
