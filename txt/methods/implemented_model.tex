...
\begin{itemize}
	...
	\item \textbf{Aggiornarsi}: ogni passo dell'agente corrisponde anche un aggiornamento dell'
	indice $R_0$ associato all'agente. Questo valore viene bilanciato in base al valore delle 
	contromisure che sono applicate all'interno del nodo in questione. Contromisure piu' stringenti
	andranno a far diminuire questo valore piu' rapidamente, mentre misure piu' blande, impiegheranno 
	maggior tempo. Lo scopo e' quello di far arrivare il valore di $R_0$ sotto \textbf{1.0}, 
	cosi' da avere una naturale estinzione sul lungo periodo \cite{wiki:Numero_di_riproduzione_di_base}
...
e infine di chiamare la funzione \textbf{controller!} la quale e' responsabile dell'applicazione delle 
contromisure all'interno del sistema. 
...
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=\textwidth]{img/SocialNetworkABM2023-07-13.pdf}
...
in questo caso non risultano troppo presenti.
...
irrealistico e associato alla definizione che e' stata fatta della funzione \textbf{happiness!}. Tuttavia anche se il comportamento di questa curva non e' 
