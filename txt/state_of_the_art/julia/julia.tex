...
Il cuore di ogni rete neurale è l'abilità di propagare all'indietro \cite{wiki:Backpropagation} lungo tutta la 
...
dove $\alpha(t)$ è una funzione a ritardo e $W(t)$ è un processo Wiener \cite{wiki:Processo_di_Wiener}.
...
soluzione liscia\cite{wiki:Smoothness} (una funzione è considerabile liscia se è 
